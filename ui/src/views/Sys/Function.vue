<template>
  <div class="page-container">
    ...
    >
      ...
      <el-table-column prop="authority" header-align="center" label="功能授权">
      </el-table-column>

      <el-table-column prop="type" header-align="center" label="数据类型" align="center" width="70">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.type === 1" size="small">目录</el-tag>
          <el-tag v-else-if="scope.row.type === 0" size="small">功能</el-tag>
        </template>
      </el-table-column>
