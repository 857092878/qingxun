package com.ustb.evaluation.mod05test.domain.StudeentAllshow;
...
@Component
public class StudentAllshowConstant extends TableConstant<StudentAllshow> { public StudentAllshowConstant() {
 super();
 }
